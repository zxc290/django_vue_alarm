...
class ServerTable(models.Model):
    ...
    ptname = models.CharField(db_column='PtName', max_length=20, blank=True, null=True, verbose_name='平台')
    zonename = models.CharField(db_column='ZoneName', max_length=1024, blank=True, null=True, verbose_name='区服')
