# Generated by Django 2.1.3 on 2019-01-24 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alarm_type', models.CharField(max_length=20, unique=True, verbose_name='报警类型')),
        ...
        migrations.AddField(
            ...
            name='send_rules',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mail_operations', to='server_alarm.SendRule', verbose_name='发送规则'),
        ),
        migrations.AddField(
            model_name='alarmrule',
            name='send_rules',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alarm_rules', to='server_alarm.SendRule', verbose_name='发送规则'),
        ),
    ]
