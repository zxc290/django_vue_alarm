...
#     mail_operation = GameOperation.objects.create(game=game, receiver=receiver)
...
#     mail_operation_list = [GameOperation.objects.get(id=each) for each in mail_operation_id_list]
...
#     # alarm_id = data.get('alarmId')
#     # alarm_rule = Alarm.objects.get(id=alarm_id)
#     # mail_operation = GameOperation.objects.filter(game=game, receiver=receiver).first()
#     # alarm_rule.GameOperation_set.remove(mail_operation)
#     # mail_operation.delete()
#     msg = {'code': 1, 'message': '成功'}
#     return Response(msg)
